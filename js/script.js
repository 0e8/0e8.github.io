...
const commands = {
	...
	{
		cmd: 'aboutme',
		res: 'About Me:<br># <span class="red">Real Name:</span> Maciej<br># <span class="red">Country:</span> Poland<br><br>Bio:<br># <span class="red">Programming:</span> HTML, CSS, JS, Python<br># <span class="red">Languages:</span><br>- English <span class="red">(Intermediate)</span><br>- Polish <span class="red">(Native)</span>'
	},
	links: 
	{
		cmd: 'links',
		res: 'Links:<br># <span class="red"><a href="https://discord.gg/HzwJsmPfZY" target="_blank"><u>Discord</u></a></span><br># <span class="red"><a href="https://github.com/auroraauwu" target="_blank"><u>Github</u></a></span> - Github info <3. </u></a></span><br># <span class="red"><a href="https://steamcommunity.com/id/shadowwq/" target="_blank"><u>Steam</u></a></span> - You can find me there <span class="green">Online</span> most of the time.<br># <span class="red"><a href="https://twitter.com/shadowwqz" target="_blank"><u>Twitter</u></a></span> - This one is really dead <br>'
	},
	whoami: 
	{
		cmd: 'whoami',
...
var prephraseRoot = '<span class="red">root@auroraauwu.github.io</span>:<span class="blue">~</span># ';
var prephrase = '<span class="red">visitor@auroraauwu.github.io</span>:<span class="blue">~</span># ';
...
{
	var res = '';
	if (command === './welcome.sh') res = 'Welcome to <span class="red">auroraauwu.github.io</span>!<br><br>Greetings <span class="red"> Friend'+'</span> <span class="red">' +'</span> <span class="red">'+'</span><br>Total Visits: <span id="count" class="red">'+'0'+'</span><br>Terminal Updated: <span class="red"> 06/10/2021'+'</span><br><br><b>Type \'help\' for more details on the commands</b>'
	else
	{
...
$('form').on('submit', function(e) {
	...
	try {
			...
			if (vInput.startsWith("./")) {
				if (vInput === "./root/welcome.sh") {
					...
					launchCommandAsVisitor({
						cmd: vInput,
						res: '<div><p>auroraauwu.github.io: ' + vInput + ': No such file or directory</p></div>'
					});
				}
				...
				if (typeof loginArray[2] !== "undefined") {
					if (loginArray[2] === "visitor") {
						...
						res = 'auroraauwu.github.io: No passwd entry for user ' + loginArray[2] + '';
					}
					launchCommandAsVisitor({
				...
				if (vInput === "music play") {
					...
					launchCommandAsVisitor({
						cmd: vInput,
						res: '<div><p>[ <span class="red">auroraauwu.github.io</span> ] Usage: music [play/stop/link]</p></div>'
					});
				}
			} 
			else if (vInput === "sdev") {
		...
		if (root > 0) {
			launchCommandAsRoot({
				cmd: $('input').val(),
				res: '<div><p>auroraauwu.github.io: ' + $('input').val() + ': command not found</p></div>'
			});
		} else {
			launchCommandAsVisitor({
				cmd: $('input').val(),
...
function updateVisitCount() {
	fetch('https://api.countapi.xyz/hit/auroraauwu.github.io/')
		.then(res => res.json())
		.then(res => {
